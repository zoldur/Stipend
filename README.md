...
The script will install Stipend version **4.0.0.0**
***
...
```
cd /tmp
wget -N https://github.com/Stipend-Developer/stipend/releases/download/4.0.0.0/precompiled-daemon-4.0.0.0.zip
unzip precompiled-daemon-4.0.0.0.zip
systemctl stop Stipend
chmod +x stipendd
mv stipendd /usr/local/bin
systemctl start Stipend
rm precompiled-daemon-4.0.0.0.zip
cd -
```
***
